...
from ..views import ATMDetailView, edit_ATM, delete_ATM, SKPDCreateNewView, edit_SKPD, delete_SKPD, download_pdf_file
...
urlpatterns = [
    ...
    path('<int:pk>/skpd/<int:pk_skpd>/delete-skpd', delete_SKPD, name='delete_skpd'),
